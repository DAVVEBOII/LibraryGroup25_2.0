...
INSERT INTO `books` VALUES ('0007203543',NULL,'The fellowship of the ring','J.R.R. Tolkien','HarperCollins','Skönlitteratur, Fantasy, Sagan om ringen','H13R4','1933-11-05'),('1292061189',NULL,'Database systems : a practical approach to design, implementation, and management','Thomas M. Connolly, Carolyn E. Begg','Pearson Education Limited','Database management, Databases','H3R3','2015-10-04'),('9780141036144',NULL,'1984','George Orwell','Penguin Books Ltd.','Skönlitteratur, Klassisk Science Fiction','H10R4','1942-01-02'),('9780261102361',NULL,'The Two Towers','J.R.R. Tolkien','HarperCollins','Skönlitteratur, Fantasy, Lord of the rings, Sagan om ringen','H13R3','1937-10-02'),('9780261102378',NULL,'The Return of the King','J.R.R. Tolkien','HarperCollins','Skönlitteratur, Fantasy, Lord of the rings, Sagan om ringen','H13R4','1941-01-21'),('9780316389709',NULL,'Sword of destiny','Andrzej Sapkowski','Orbit','Monster, Magi, Trollkarlar, Wizards, Magic, Monsters, Romaner, Fantasy','H22R2','2001-04-20'),('9780470146354',NULL,'Software testing: Testing across the entire software development life cycle','Gerald D. Everett, Raymond McLeod, Jr.','IEEE Press','Computer software Testing, Development','H3R3','2007-11-11'),('9780575081567',NULL,'Necronomicon','H.P. Lovecraft','Gollancz','Skönlitteratur, Science Fiction','H12R2','1949-05-21'),('9781473231061',NULL,'The last wish : introducing The Witcher','Andrzej Sapkowski','Orion','Monster, Magi, Trollkarlar, Wizards, Magic, Monsters, Romaner, Fantasy','H22R1','1932-02-10'),('9781484200292',NULL,'Beginning Python : from novice to professional','Magnus Lie Hetland','Apress, cop.','Python, Programming, Programmering','H3R1','2013-12-05'),('9781847493507',NULL,'Frankenstein','Mary Shelley','Alma Classics','Skönlitteratur, Klassiker','H12R1','2000-10-11'),('9789144085876',NULL,'Java : steg för steg','Jan Skansholm','Studentlitteratur','Java, Programming, Programmering','H3R1','2019-07-13'),('9789144122991',NULL,'Interaktionsdesign och UX : om att skapa en god användarupplevelse','Mattias Arvola','Studentlitteratur AB','Studentlitteratur','H1R1','2018-12-01'),('9789176216132',NULL,'Kalle Anka: jul i Ankeborg','Walt Disney','Egmont Publishing AB','Tecknade Serier, Barn- och ungdomslitteratur','H27R1','2001-09-11');
...
INSERT INTO `dvds` VALUES (12350,NULL,'Scarface','Brian De Palma','Crime','H18R6','1976-04-30',16),(13377,NULL,'Forrest Gump','Robert Zemeckis','Comedy','H13R8','1994-05-21',13),(32690,NULL,'The Shining','Stanley Kubrick','Horror','H13R5','1981-03-11',16),(35621,NULL,'Alien','Ridley Scott','Horror','H13R5','1978-02-19',16),(42567,NULL,'The Godfather','Francis Ford Coppola','Crime','H14R7','1975-05-21',13),(43790,NULL,'American Psycho','Mary Harron','Black Comedy','H12R1','2000-04-20',16),(45623,2,'Top Gun','Joseph Kosinski','Action','H13R9','1984-03-10',13),(45624,NULL,'Skyfall','Sam Mendes','Action','H12R1','2013-12-21',13),(45783,NULL,'Gattaca','Andrew Niccol','Sci-Fi','H19R7','1993-01-25',13),(46678,NULL,'Whiplash','Damien Chazelle','Drama','H17R6','2016-07-25',16),(46698,2,'The Shawshank Redemption','Frank Darabont','Crime','H17R7','1999-03-01',16),(46741,2,'Frozen','Chris Buck','Animated','H13R8','2014-12-24',3),(47954,NULL,'Pulp Fiction','Quentin Tarantino','Drama','H10R4','1993-10-31',16),(54578,NULL,'A Goofy Movie','Kevin Lima','Animated','H14R7','1997-05-12',6),(54587,NULL,'Saving Private Ryan','Steven Spielberg','War','H8R6','1994-04-12',16),(56821,NULL,'Fight Club','David Fincher','Thriller','H11R1','1992-08-08',16),(56987,NULL,'Good Will Hunting','Gus Van Sant','Drama','H10R7','1994-12-12',13),(57890,NULL,'Rocky','John G. Avildsen','Drama','H14R6','1978-05-06',13),(66621,NULL,'The Wolf of Wall Street','Martin Scorsese','Biographical','H14R3','2013-12-21',16),(67534,NULL,'Jurassic Park','Steven Spielberg','Adventure','H16R5','1991-09-11',13),(69420,NULL,'The Dark Knight','Christopher Nolan','Action','H13R5','2008-05-05',13),(76580,NULL,'Avatar','James Cameron','Sci-Fi','H12R3','2010-12-01',13),(78452,NULL,'Schindlers List','Steven Spielberg','War','H12R5','1993-05-12',16),(78456,NULL,'Halloween','John Carpenter','Horror','H14R1','1978-10-31',16),(78905,NULL,'Inglorious Basterds','Quentin Tarantino','Action','H12R7','2009-08-08',16),(84532,2,'Slumdog Millionaire','Danny Boyle','Drama','H15R5','2010-03-01',13),(85621,2,'Toy Story','John Lasseter','Family','H11R5','1997-03-31',3),(87612,NULL,'Toy Story 2','John Lasseter','Family','H11R6','2000-08-12',3);
...
CREATE TABLE `users` (
  ...
  `email` varchar(254) NOT NULL,
  `pwd` varchar(45) NOT NULL,
  `uType` varchar(5) NOT NULL DEFAULT 'S',
...
INSERT INTO `users` VALUES ('IQ9000Scientist','Valter','Jönnson','jönnson@ltu.se','ftp','R'),('JökenSwe','Jocke','Edstrand','Jocke@ltu.se','qwerty','S'),('LärarIngejör','Karl','Johansson','johansson@ltu.se','katy','E'),('ragnvald10','Ragnvald','Helgesson','ragnvald.helgesson@mailinater.com','loppis','S'),('runa71','Runa','Källgren','runa.kallgren@ltu.se','yahoo','R'),('SigIva','Sigurt','Ivarsson','sigiva@hotmail.se','pollen','P'),('Willeboii','William','Lydahl','lydahl@ltu.se','hej','S');
...
INSERT INTO `usertype` VALUES ('E','Employee'),('L','Librarian'),('M','Manager'),('P','Public'),('R','Researcher'),('S','Sudent');
...
SELECT DISTINCT * FROM library.user
    WHERE user.pwd LIKE CONCAT('%',v_search,'%');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	...
	DECLARE v_todaysDate DATETIME;
    
	SET v_todaysDate = (SYSDATE());
	SET v_tempDate = (SELECT CAST(v_todaysDate AS DATE));

	INSERT INTO loans (borrowedDate, barcode, username) VALUES (v_tempDate, v_barcode, v_username);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2022-05-05 11:44:32
